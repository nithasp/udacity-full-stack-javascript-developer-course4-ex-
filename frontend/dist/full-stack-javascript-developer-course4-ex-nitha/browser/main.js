...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-E2LLPT4X.js").then((m) => m.AuthModule)
  },
  {
    path: "products",
    loadChildren: () => import("./chunk-UW7PZOB5.js").then((m) => m.ProductsModule),
    canActivate: [authGuard]
  },
  {
    path: "cart",
    loadChildren: () => import("./chunk-W54RNSKW.js").then((m) => m.CartModule),
    canActivate: [authGuard]
  },
...
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [[1, "main-content"]], template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
